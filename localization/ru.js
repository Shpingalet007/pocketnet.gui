...
____loclib.embeddingSettings = "Встраивание настроек"
...
____loclib.postRemoved = "Пост удален"
...
____loclib.removePostDialog = "Вы действительно хотите удалить пост?"
____loclib.opennewwindow = "Открыть пост в новом окне"
____loclib.pin = "Закрепить пост"
____loclib.pinned = "закреплённый пост"
____loclib.pinPostDialog = "Вы действительно хотите закрепить этот пост?"
____loclib.unpin = "Открепить пост"
____loclib.unpinPostDialog = "Вы действительно хотите открепить этот пост?"
...
____loclib.pbp_3 = "Каждые 15 тысяч просмотров видео + 1250 пятизвёздочных рейтингов от уникальных пользователей"
...
____loclib.pbp_6_3 = 'Важно: Начиная с 1-го ноября вступает в силу дополнительное ограничение: вы должны иметь +1000 реферальных пользователей для получения каждого бонуса. Чтобы привлечь реферальных пользователей включайте реферальную часть в ссылку в окне "Поделиться".'
...
____loclib.downloadedEmpty = "Сохранённые посты будут показаны здесь";
...
____loclib.aboutServices13 = 'Существует множество способов монетизации вашего контента с помощью Pocketcoin (PKOIN). Вы зарабатываете PKOIN за популярный контент, пользователи могут прикреплять PKOIN к комментариям. В декабре 2021 года планируется выпуск децентрализованного рекламного маркетплейса, 100% дохода которого будут поступать блогерам.  ';
...
____loclib.aboutNewBlock6 = 'Децентрализованная рекламная площадка, релиз которой запланирован на декабрь 2021 года, позволит рекламодателям создавать посты и предлагать их блогерам. Блогер может изучить рекламный пост и сделать репост, если он подходит. Все взаимодействия на канале блоггеров будут поступать непосредственно в кошелек блоггера, 100% выручки от рекламы.';
...
____loclib.aboutTitterImgAndText9 = '1. Вы никогда не будете заблокированы или забанены за то, что просто поддерживаете свои идеи, религии, движения, не причиняя вреда другим людям';
____loclib.aboutTitterImgAndText10 = '2. Никто не может заблокировать ваш аккаунт или удалить ваши сообщения';
____loclib.aboutTitterImgAndText11 = '3. Конфиденциальность полная и гарантированная';
____loclib.aboutTitterImgAndText12 = '4. Доступ всегда возможен из любой страны и региона мира';
____loclib.aboutTitterImgAndText13 = '5. Сеансы чата полностью приватны и зашифрованы, и даже Bastyon не может получить к ним доступ. Даже с судебным ордером.';
____loclib.aboutTitterImgAndText14 = '6. Ваши сообщения могут быть длиннее';
...
____loclib.aboutFbImgAndText7 = '1. Ваши личные данные не продаются сторонним компаниям';
____loclib.aboutFbImgAndText8 = '2. Нет произвольной цензуры';
____loclib.aboutFbImgAndText9 = '3. Не собирает личную информацию';
____loclib.aboutFbImgAndText10 = '4. За ним не стоит корпорация';
____loclib.aboutFbImgAndText11 = '5. Сеансы чата полностью приватны и зашифрованы, и даже Bastyon не может получить к ним доступ';
____loclib.aboutFbImgAndText12 = '6. Марк Цукерберг вас не побеспокоит!';
...
____loclib.aboutHowItWImgAndText8 = 'От биткоинов до Bastyonа.';
...
____loclib.aboutHowItWImgAndText12 = 'Подумайте о криптовалюте: когда вы отправляете кому-то биткоины (или их часть), транзакция регистрируется в блокчейне.';
...
____loclib.aboutHowItWImgAndText14 = 'Bastyon работает ТОЧНО так же. Каждый пост, каждый аккаунт, каждое видео записывается в блокчейн. И, попав туда, оно не может быть удалено.';
...
____loclib.aboutHowItWImgAndText27 = '1. Вы можете зарегистрироваться, не сообщая свой номер телефона (требуется только электронная почта)';
____loclib.aboutHowItWImgAndText28 = '2. Bastyon не запрашивает ваше настоящее имя для защиты инакомыслия';
____loclib.aboutHowItWImgAndText29 = '3. Bastyon не собирает IP-адреса и не отслеживает вас';
____loclib.aboutHowItWImgAndText291 = '4. Bastyon позволяет использовать несколько аккаунтов для разных целей';
...
____loclib.aboutHowItWImgAndText51 = 'Почему криптовалюта полезна для свободы?';
____loclib.aboutHowItWImgAndText52 = 'Некоторые люди считают, что цифровая валюта - это инструмент для порабощения. Как ни странно, многие из этих людей носят в карманах банковские карты с микрочипом. Банковские карты, которые отслеживают каждую покупку и привязаны непосредственно к вашей личности. Причина, по которой криптовалюта полезна для свободы, заключается в том, что она не привязана к вашей личности. Как в Bitcoin, так и в Pocketcoin каждый пользователь может создавать миллионы адресов и менять их столько, сколько нужно.';
...
____loclib.ContentCreatorsImgAndText2 = '15 000 видео, 1250 реакций от разных пользователей и 1000 приглашенных пользователей на ваш канал';
...
____loclib.ContentCreatorsImgAndText26 = 'Комментарии с PKOIN отображаются под вашим постом';
...
____loclib.works2 = 'Bastyon также является платформой для обмена видео, которая, в отличие от традиционных и популярных социальных сетей, обеспечивает конфиденциальность и свободу от произвольной цензуры';
____loclib.works3 = 'Bastyon также является частной и ориентированной на свободу финансовой системой на базе Pocketcoin (PKOIN), которая используется для продвижения контента и товаров';
____loclib.works4 = 'Нами движет СВОБОДА';
____loclib.works5 = 'Не зависит от корпораций';
____loclib.works6 = 'Не зависит от банков в финансировании и операциях';
